...
constexpr byte ALPHABET[] { 0x88, 0x83, 0xC6, 0xA1, 0x86, 0x8E, 0x82, 0x89, 0xF9, 0xE1, 0x85, 0xC7, 0xC8, 0xAB, 0xA3, 0x8C, 0x98, 0xAF, 0x92, 0x87, 0xC1, 0xE3, 0x81, 0xB6, 0x91, 0xA4 };
constexpr byte ALPHABET_SIZE = sizeof(ALPHABET) / sizeof(ALPHABET[0]);
constexpr byte SPACE_CHAR = 0xFF;
